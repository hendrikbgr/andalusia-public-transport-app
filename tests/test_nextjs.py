...
class TestNextStationUI:
    ...
    def test_station_name_loads(self, nx_page):
        ...
        # Header h1 should eventually contain stop name
    ...
    def test_qr_modal_opens_and_closes(self, nx_page):
        ...
        expect(nx_page.locator(".qr-overlay, .qr-modal")).to_be_visible(timeout=TIMEOUT)
        # Close it
...
class TestNextPlannerUI:
    ...
    def test_coin_to_alhaurin_search_shows_results(self, nx_page):
        ...
        # From: Coín
        nx_page.locator("#from-input").fill("Coin")
        ...
        nx_page.locator("#to-input").fill("Alhaurin el Grande")
